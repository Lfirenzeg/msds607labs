...
Once we have a .csv file containing the list of skills for each job post we can proceed to organize the information pulled with Python a bit more.
...
To organize the data a bit more, we'll be separating the companies_skills_df table into two separate tables—one focused on company information and the other on skills
```{r, splitting a table}
